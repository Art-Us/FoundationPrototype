      ...
      // 1. DOLNOŚLĄSKIE - Kłodzko
      {
        ...
        posts: [
          ...
          },
          {
            ...
            organizationName: 'Fundacja Ratownictwa i Pomocy Q',
            role: 'admin',
            title: 'Punkt dystrybucji osuszaczy i agregatów prądotwórczych',
            content: 'Przy OSiR Kłodzko uruchomiono centralny punkt wydawania sprzętu osuszającego dla mieszkańców poszkodowanych rejonów. Wydawanie odbywa się za okazaniem protokołu zalania.',
            postType: 'logistyka',
            ...
            messages: [
              {
                ...
                organizationName: 'Urząd Miasta i Gminy Kłodzko',
                role: 'koordynator',
                content: 'Potwierdzam, punkt obsługują wspólnie wolontariusze Fundacji Q i pracownicy MOPS.',
          ...
          },
          {
            ...
            organizationName: 'Ochotnicza Straż Pożarna Kłodzko',
            role: 'czlonek',
            title: 'Zapotrzebowanie na worki i piasek – rejon Nysa Kłodzka',
            content: 'Zużyliśmy już 1500 worków przy zabezpieczeniu mostu żelaznego. Potrzebujemy dodatkowej wywrotki piasku oraz 20 osób do napełniania.',
            postType: 'prosba_o_pomoc',
            ...
            messages: [
              {
                ...
                organizationName: 'Urząd Miasta i Gminy Kłodzko',
                role: 'koordynator',
                content: 'Dwie wywrotki z piaskarni w Szalejowie są już w drodze.',
      ...
      // 2. DOLNOŚLĄSKIE - Wrocław
      {
        ...
        posts: [
            ...
            messages: [
              {
                ...
                authorName: 'Robert Wodny',
                organizationName: 'Dolnośląskie WOPR Wrocław',
                role: 'czlonek',
                content: 'Odebraliśmy 3 łodzie płaskodenne i silniki zaburtowe. Sprzęt sprawny, gotowy do patrolowania.',
                createdAt: new Date(now - 3 * oneHour).toISOString(),
              },
              {
                id: 'm-wro-2',
                ...
                role: 'koordynator',
                content: 'Z Warszawy wyjechał kolejny transport z 400 zestawami higienicznymi i kocami.',
                createdAt: new Date(now - 2 * oneHour).toISOString(),
              },
            ],
          },
          {
            ...
            organizationName: 'Dolnośląskie WOPR Wrocław',
            role: 'czlonek',
            title: 'Raport patrolu motorowodnego WOPR – Jaz Opatowice i Bartoszowice',
            content: 'Wszystkie zasuwy jazu Bartoszowice otwarte na maksymalny przepływ. Brak zatorów z konarów i śmieci. Sytuacja pod stałym nadzorem.',
            postType: 'raport_terenowy',
            createdAt: new Date(now - 2 * oneHour).toISOString(),
            messages: [
              {
                ...
                organizationName: 'Fundacja Ratownictwa i Pomocy Q',
                role: 'admin',
                content: 'Dobra robota Robert. Utrzymujcie łączność na kanale ratowniczym.',
                createdAt: new Date(now - 1 * oneHour).toISOString(),
              },
            ],
          },
      ...
      // 3. MAŁOPOLSKIE - Kraków
      {
        ...
        posts: [
            ...
            messages: [
              {
                ...
                organizationName: 'Fundacja Ratownictwa i Pomocy Q',
                role: 'admin',
                content: 'Dodatkowe 20 rękawów wodnych zostało przekierowanych z Nowego Sącza do Krakowa.',
                createdAt: new Date(now - 8 * oneHour).toISOString(),
              },
            ],
          },
          {
            ...
            organizationName: 'Wydział Bezpieczeństwa UMK Kraków',
            role: 'koordynator',
            title: 'Inspekcja przepompowni Nowy Świat i Lesisko',
            content: 'Przepompownie pracują w trybie automatycznym. Poziom wód gruntowych stabilny, monitorujemy stan wałów za pomocą dronów termowizyjnych.',
            postType: 'raport_terenowy',
            createdAt: new Date(now - 5 * oneHour).toISOString(),
            messages: [],
          },
        ...
        posts: [
          {
            ...
            content: 'Trwa usuwanie kilkudziesięciu powalonych świerków. Policja kieruje ruchem przez Poronin. TOPR wspiera działania przy szlakach reglowych.',
            postType: 'raport_terenowy',
            createdAt: new Date(now - 4 * oneHour).toISOString(),
            messages: [
              {
                ...
                organizationName: 'Fundacja Ratownictwa i Pomocy Q',
                role: 'admin',
                content: 'Podhalańska grupa pilarzy z Nowego Targu została skierowana w rejon Kościeliska.',
                createdAt: new Date(now - 2 * oneHour).toISOString(),
              },
            ],
          },
          {
            ...
            organizationName: 'Wydział Bezpieczeństwa UMK Kraków',
            role: 'koordynator',
            title: 'Zabezpieczenie zerwanych dachów na Cyrhli',
            content: 'Strażacy zabezpieczają 4 uszkodzone poszycia dachowe przy użyciu plandek zbrojonych. Wiatr powoli słabnie.',
            postType: 'raport_terenowy',
            createdAt: new Date(now - 1 * oneHour).toISOString(),
            messages: [],
          },
        ...
        posts: [
          {
            ...
            messages: [
              {
                id: 'm-waw-1',
                authorId: pspWarszawa.id,
                authorName: 'Adam Oficer-PSP',
                organizationName: 'Komenda Wojewódzka PSP w Warszawie',
                role: 'czlonek',
                content: 'Maszty oświetleniowe z JRG 3 zostały rozstawione wzdłuż odcinka Wilanów-Siekierki.',
          ...
          {
            id: 'post-waw-2',
            authorId: pckWarszawa.id,
            authorName: 'Ewa Wolontariusz-PCK',
            organizationName: 'Polski Czerwony Krzyż - Zarząd Główny',
            role: 'czlonek',
            title: 'Punkt socjalny dla ratowników i służb mundurowych',
            content: 'Na wysokości Mostu Poniatowskiego działa mobilny namiot grzewczy PCK z ciepłymi posiłkami i napojami dla wszystkich jednostek pracujących przy rzece.',
            postType: 'logistyka',
            createdAt: new Date(now - 6 * oneHour).toISOString(),
            messages: [],
          },
        ...
        posts: [
          {
            ...
            organizationName: 'Stołeczne Centrum Bezpieczeństwa Warszawa',
            role: 'koordynator',
            title: 'Lodołamacze na Zbiorniku Włocławskim w akcji',
            content: 'Sześć lodołamaczy Wód Polskich kruszy zator poniżej mostu Legionów Piłsudskiego. Odpływ wody wzrósł o 20%.',
            postType: 'raport_terenowy',
            createdAt: new Date(now - 15 * oneHour).toISOString(),
            messages: [
              {
                id: 'm-plo-1',
                authorId: admin.id,
                ...
                organizationName: 'Fundacja Ratownictwa i Pomocy Q',
                role: 'admin',
                content: 'Dodatkowy transport 2500 worków jutowych dotrze do portu rzecznego o 14:00.',
                createdAt: new Date(now - 11 * oneHour).toISOString(),
              },
            ],
          },
          {
            ...
            organizationName: 'Polski Czerwony Krzyż - Zarząd Główny',
            role: 'czlonek',
            title: 'Dystrybucja wody i żywności – Lewobrzeżny Płock (Radziwie)',
            content: 'W Szkole Podstawowej nr 5 uruchomiono punkt wydawania wody pitnej i suchych racji żywnościowych dla mieszkańców z odciętych posesji.',
            postType: 'logistyka',
      ...
      // 7. POMORSKIE - Gdańsk
      {
        ...
        posts: [
            ...
            messages: [
              {
                ...
                organizationName: 'Dolnośląskie WOPR Wrocław',
                role: 'czlonek',
                content: 'Jeśli potrzebujecie dodatkowych pomp szlamowych, możemy przesłać 4 jednostki z rezerwy krajowej.',
                createdAt: new Date(now - 2 * oneHour).toISOString(),
              },
            ],
          },
          {
            ...
            organizationName: 'Morski Oddział Ratownictwa Wodnego Gdańsk',
            role: 'koordynator',
            title: 'Komunikat żeglugowy i ostrzeżenie sztormowe 9B',
            content: 'Wstrzymano ruch jednostek turystycznych i tramwaju wodnego. Wyznaczono patrole brzegowe w rejonie Brzeźna i Jelitkowa.',
            postType: 'komunikat_sztabowy',
            createdAt: new Date(now - 1 * oneHour).toISOString(),
            messages: [],
          },
        ...
        posts: [
          {
            ...
            organizationName: 'Morski Oddział Ratownictwa Wodnego Gdańsk',
            role: 'koordynator',
            title: 'Zasilanie awaryjne Wojewódzkiego Szpitala Specjalistycznego w Słupsku',
            content: 'Dwa agregaty o mocy 250 kW podłączone do bloku operacyjnego i OIOM. Działa również oświetlenie awaryjne.',
            postType: 'raport_terenowy',
            createdAt: new Date(now - 8 * oneHour).toISOString(),
            messages: [
              {
                ...
                organizationName: 'Fundacja Ratownictwa i Pomocy Q',
                role: 'admin',
                content: 'Dostarczono cysternę z olejem napędowym do zasilania agregatów na kolejne 48h pracy.',
                createdAt: new Date(now - 5 * oneHour).toISOString(),
              },
            ],
          },
        ...
        posts: [
          {
            ...
            organizationName: 'Morski Oddział Ratownictwa Wodnego Gdańsk',
            role: 'koordynator',
            title: 'Zabezpieczenie obiektów zabytkowych na Nabrzeżu Wieleckim',
            content: 'Rozstawiono 350 metrów zapór aluminiowych. Woda utrzymuje się 15 cm poniżej korony nabrzeża.',
            postType: 'raport_terenowy',
            createdAt: new Date(now - 9 * oneHour).toISOString(),
            messages: [
              {
                ...
                organizationName: 'Dolnośląskie WOPR Wrocław',
                role: 'czlonek',
                content: 'Patrole WOPR prowadzą stały nasłuch radiowy na kanale 16 VHF.',
                createdAt: new Date(now - 6 * oneHour).toISOString(),
              },
            ],
          },
        ...
        posts: [
          {
            ...
            organizationName: 'Fundacja Ratownictwa i Pomocy Q',
            role: 'admin',
            title: 'Centrum Przeładunkowe MTP Poznań',
            content: 'Teren Międzynarodowych Targów Poznańskich służy jako punkt zborny konwojów humanitarnych zmierzających na Dolny Śląsk i Opolszczyznę.',
            postType: 'logistyka',
            createdAt: new Date(now - 12 * oneHour).toISOString(),
            messages: [
              {
                ...
                organizationName: 'Polski Czerwony Krzyż - Zarząd Główny',
                role: 'czlonek',
                content: 'Trzy TIR-y z żywnością długoterminową dotarły i zostały sformowane w jeden konwój z cysternami.',
                createdAt: new Date(now - 7 * oneHour).toISOString(),
              },
            ],
          },
        ...
        posts: [
          {
            ...
            organizationName: 'Fundacja Ratownictwa i Pomocy Q',
            role: 'admin',
            title: 'Ewakuacja 80 sztuk bydła z zalewowej doliny Prosny',
            content: 'Działania prowadzone przy wsparciu OSP i lokalnych hodowców. Zwierzęta umieszczono w wyższych budynkach gospodarczych w Opatówku.',
            postType: 'raport_terenowy',
            createdAt: new Date(now - 4 * oneHour).toISOString(),
            messages: [],
          },
        ...
        posts: [
          {
            ...
            organizationName: 'Fundacja Ratownictwa i Pomocy Q',
            role: 'admin',
            title: 'Ochrona Ujęcia Wody Zwięczyca',
            content: 'Rozstawiono wały ochronne wokół pompowni głównej. Jakość wody w sieci miejskiej spełnia wszystkie normy.',
            postType: 'raport_terenowy',
            createdAt: new Date(now - 6 * oneHour).toISOString(),
            messages: [],
          },
        ...
        posts: [
          {
            ...
            organizationName: 'Fundacja Ratownictwa i Pomocy Q',
            role: 'admin',
            title: 'Raport z punktu recepcyjnego Dworzec Główny Przemyśl',
            content: 'Punkt działa płynnie. Zapewniono ciepłe posiłki, wsparcie psychologiczne oraz transport do miejsc zakwaterowania tymczasowego.',
            postType: 'logistyka',
            createdAt: new Date(now - 14 * oneHour).toISOString(),
            messages: [
              {
                ...
                organizationName: 'Polski Czerwony Krzyż - Zarząd Główny',
                role: 'czlonek',
                content: 'Dodatkowy zespół ratowników medycznych PCK objął dyżur nocny.',
                createdAt: new Date(now - 8 * oneHour).toISOString(),
              },
            ],
          },
        ...
        posts: [
          {
            ...
            organizationName: 'Wydział Bezpieczeństwa UMK Kraków',
            role: 'koordynator',
            title: 'Sytuacja w centrum miasta i dolinie rzeki Białej',
            content: 'Udrożniono główne arterie: ul. Partyzantów i ul. 3 Maja. Trwają intensywne odpompowywania wody z podziemnych kondygnacji galerii handlowych.',
            postType: 'raport_terenowy',
            createdAt: new Date(now - 3 * oneHour).toISOString(),
            messages: [
              {
                ...
                organizationName: 'Ochotnicza Straż Pożarna Kłodzko',
                role: 'czlonek',
                content: 'Trzymamy kciuki za chłopaków z Bielska, w razie potrzeby możemy oddelegować sekcję z agregatem.',
                createdAt: new Date(now - 1 * oneHour).toISOString(),
              },
            ],
          },
        ...
        posts: [
          {
            id: 'post-rac-1',
            authorId: koordNysa.id,
            authorName: 'Tomasz Koordynator-Nysa',
            organizationName: 'Komenda Powiatowa PSP w Nysie',
            role: 'koordynator',
            title: 'Stan napełnienia czaszy Zbiornika Racibórz Dolny',
            content: 'Zbiornik zgromadził aktualnie 110 mln m3 wody. Zapory ziemne i upusty denne funkcjonują stabilnie bez żadnych anomalii filtracyjnych.',
            postType: 'komunikat_sztabowy',
            createdAt: new Date(now - 11 * oneHour).toISOString(),
            messages: [
              {
                ...
                organizationName: 'Fundacja Ratownictwa i Pomocy Q',
                role: 'admin',
                content: 'Dzięki spłaszczeniu fali przez Racibórz sytuacja w Opolu i Wrocławiu jest pod pełną kontrolą.',
                createdAt: new Date(now - 6 * oneHour).toISOString(),
              },
            ],
          },
        ...
        posts: [
          {
            ...
            organizationName: 'Komenda Powiatowa PSP w Nysie',
            role: 'koordynator',
            title: 'Uszczelnianie wyrwy w koronie wału przy moście Kościuszki',
            content: 'Śmigłowce Wojska Polskiego zrzuciły 15 worków big-bag. Żołnierze WOT i strażacy układają geowłókninę i worki uszczelniające.',
            postType: 'raport_terenowy',
            createdAt: new Date(now - 7 * oneHour).toISOString(),
            messages: [
              {
                ...
                organizationName: 'Fundacja Ratownictwa i Pomocy Q',
                role: 'admin',
                content: 'Kolejne 20 rolek geowłókniny dostarczone do bazy operacyjnej przy ul. Otmuchowskiej.',
                createdAt: new Date(now - 4 * oneHour).toISOString(),
              },
            ],
          },
        ...
        posts: [
          {
            ...
            organizationName: 'Komenda Powiatowa PSP w Nysie',
            role: 'koordynator',
            title: 'Budowa mostu pontonowego i umacnianie nabrzeża',
            content: 'Batalion saperów rozpoczął montaż konstrukcji DMS-65. Dojazd dla karetek i zaopatrzenia zostanie przywrócony w ciągu 24 godzin.',
            postType: 'raport_terenowy',
            createdAt: new Date(now - 10 * oneHour).toISOString(),
            messages: [],
          },
        ...
        posts: [
          {
            ...
            organizationName: 'Fundacja Ratownictwa i Pomocy Q',
            role: 'admin',
            title: 'Zrzut wód z Zalewu Zemborzyckiego',
            content: 'Poziom wód stabilizuje się. Prace pompowe przy al. Unii Lubelskiej zapobiegły zalaniu jezdni.',
            postType: 'komunikat_sztabowy',
            createdAt: new Date(now - 13 * oneHour).toISOString(),
            messages: [],
          },
        ],
      },
        ...
        posts: [
          {
            ...
            organizationName: 'Fundacja Ratownictwa i Pomocy Q',
            role: 'admin',
            title: 'Zamknięcie Bram Przeciwpowodziowych Toruńskiej Starówki',
            content: 'Wszystkie 4 bramy grodziowe (Mostowa, Klasztorna, Żeglarska, Łazienna) zostały opuszczone i uszczelnione elastomerem.',
            postType: 'komunikat_sztabowy',
        ...
        posts: [
          {
            ...
            organizationName: 'Fundacja Ratownictwa i Pomocy Q',
            role: 'admin',
            title: 'Udrożnienie korytarza transportowego DK16',
            content: 'Droga krajowa nr 16 jest już w pełni przejezdna na odcinku Olsztyn - Ostróda. Działania skupiają się na drogach lokalnych wokół jezior.',
            postType: 'raport_terenowy',
            createdAt: new Date(now - 10 * oneHour).toISOString(),
            messages: [],
          },
